 ...
 * @private
 */
Code.TABS_ = ['blocos', 'javascript', 'php', 'python', 'dart', 'lua', 'java', 'c', 'c++', 'xml'];

Code.selected = 'blocos';
...
//http://jsfiddle.net/TechplexEngineer/geLvp6bo/
...
// If the XML tab was open, save and render the content.
  ...
  if (document.getElementById('blocos').className == 'tabon') {
...
Code.checkAllGeneratorFunctionsDefined = function (generator) {
    ...
    if (!valid) {
        var msg = 'O código gerador para os seguintes blocos não especificados para '
...
Code.init = function () {
    ...
    var onresize = function (e) {
        ...
        if (Code.workspace && Code.workspace.toolbox_.width) {
            document.getElementById('blocos').style.minWidth =
...
Code.initLanguage = function () {
    ...
    document.getElementById('blocos').textContent = MSG['blocks'];
